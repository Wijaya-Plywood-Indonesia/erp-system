...
class LaporanJoinExport implements FromCollection, WithHeadings, WithTitle
{
    ...
    public function collection()
    {
        ...
        foreach ($this->data as $groupKey => $items) {
            ...
            // =============================
            $rows->push(['MEJA / AREA', $nomorMeja]);
            $rows->push(['UKURAN', $ukuran]);
            $rows->push(['JENIS BARANG', $jenisBarang]);
            ...
            $rows->push([
                ...
                'Jam Pulang',
                'Ijin',
                'Potongan Target', // Ganti judul kolom agar sesuai
                'Keterangan',
                '',
                'Target Harian',
                'Hasil Produksi',
