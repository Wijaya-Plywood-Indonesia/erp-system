...
class LaporanPotAfalanJoinExport implements FromCollection, WithHeadings, WithTitle
{
    protected Collection $data;

    public function __construct(array $dataProduksi)
    {
        // GROUPING: NOMOR MEJA + KODE UKURAN (Konsisten dengan alur Potong Afalan Joint)
    ...
    public function collection()
    {
        ...
        foreach ($this->data as $groupKey => $items) {
            ...
            // ==========================================
            // HEADER INFORMASI (BLOK ATAS POTONG AFALAN)
            // ==========================================
    ...
    {
        // Menggunakan push manual agar bisa kustom per blok informasi
        return [];
    }

    public function title(): string
    {
        return 'Laporan Potong Afalan Joint';
    }
}
