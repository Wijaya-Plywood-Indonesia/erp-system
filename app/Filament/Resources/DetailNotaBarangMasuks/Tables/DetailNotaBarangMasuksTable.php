...
{ 
    ...
    /** 
     * Form fields untuk Platform Jadi — dipakai bersama oleh Tambah & Edit. 
     * Beda dengan Plywood: Platform Jadi diidentifikasi lewat id_jenis_barang 
     * (master JenisBarang), bukan id_jenis_kayu. 
     */ 
    protected static function platformJadiFormSchema(): array 
    { 
        return [ 
            Select::make('id_ukuran') 
                ->label('Ukuran') 
            ...
            Placeholder::make('stok_saat_ini') 
                ...
                ->content(function (callable $get) { 
                    ...
                    if (! $u || ! $get('id_jenis_barang') || ! $get('kw_grade')) { 
                        return new HtmlString('<span class="text-gray-400 dark:text-gray-500">Silakan lengkapi pilihan di atas...</span>'); 
                    } 
 
                    $stok = static::cariStokPlatformJadi($u, $get('id_jenis_barang'), $get('kw_grade')); 
                    $lembar = $stok ? (int) $stok->stok_lembar : 0; 
    ...
    /** 
     * Form fields untuk Platform Mth (setengah jadi) — dipakai bersama oleh Tambah & Edit. 
     * Sama seperti Plywood: diidentifikasi lewat id_jenis_kayu. 
     */ 
    protected static function platformMthFormSchema(): array 
    { 
        return [ 
            Select::make('id_ukuran') 
                ->label('Ukuran') 
            ...
            Placeholder::make('stok_saat_ini') 
                ...
                ->content(function (callable $get) { 
                    ...
                    $stok = static::cariStokPlatformMth($u, $get('id_jenis_kayu'), $get('kw_grade')); 
                    $lembar = $stok ? (int) $stok->stok_lembar : 0; 
                ...
                ActionGroup::make([ 
                    ...
                    Action::make('tambah_platform') 
                        ...
                        ->form([ 
                            ...
                            Placeholder::make('stok_saat_ini') 
                                ...
                                ->content(function (callable $get) { 
                                    ...
                                    if (! $tipe || ! $idUkuran || ! $get('kw_grade')) { 
                                        return new HtmlString('<span class="text-gray-400 dark:text-gray-500">Silakan lengkapi pilihan di atas...</span>'); 
                                    } 
 
                                    if ($tipe === 'jadi') { 
                                        if (! $get('id_jenis_barang')) { 
                                            return new HtmlString('<span class="text-gray-400 dark:text-gray-500">Silakan pilih jenis barang...</span>'); 
                                        } 
 
                                        $stok = static::cariStokPlatformJadi( 
                                            $ukuran, 
                                            $get('id_jenis_barang'), 
                                            $get('kw_grade') 
                                        ); 
                                        ...
                                        if (! $get('id_jenis_kayu')) { 
                                            return new HtmlString('<span class="text-gray-400 dark:text-gray-500">Silakan pilih jenis kayu...</span>'); 
                                        } 
 
                                        $stok = static::cariStokPlatformMth( 
                                            $ukuran, 
                                            $get('id_jenis_kayu'), 
                                            $get('kw_grade') 
                                        ); 
                        ...
                        ->action(function (RelationManager $livewire, array $data) { 
                            ...
                            $isKeluar = $nota instanceof NotaBarangKeluar; 
                            $tipePlatform = $data['tipe_platform']; 
 
                            if ($tipePlatform === 'jadi') { 
                                ...
                                $payload = [ 
                                    ...
                                    'jumlah' => $qty, 
                                    'satuan' => 'Lembar', 
                                    'keterangan' => $data['keterangan'] ?? 'Otomatis dari Mutasi Platform Jadi', 
                                ]; 
                                ...
                                $payload = [ 
                                    ...
                                    'jumlah' => $qty, 
                                    'satuan' => 'Lembar', 
                                    'keterangan' => $data['keterangan'] ?? 'Otomatis dari Mutasi Platform Mth', 
                                ]; 
                ...
                Action::make('validasi_nota') 
                    ...
                    ->action(function (RelationManager $livewire) { 
                        ...
                        try { 
                            ...
                            $hasPlatformJadi = PlatformJadiMutasi::where('id_nota_bm', $nota->id)->exists(); 
                            $hasPlatformMth = PlatformMthMutasi::where('id_nota_bm', $nota->id)->exists(); 
                ...
                EditAction::make() 
                    ->form(function ($record) { 
                        ...
                        if (str_starts_with($record->nama_barang, 'Platform Jadi ')) { 
                            return static::platformJadiFormSchema(); 
                        } 
 
                        if (str_starts_with($record->nama_barang, 'Platform Mth ')) { 
                            return static::platformMthFormSchema(); 
                        } 
