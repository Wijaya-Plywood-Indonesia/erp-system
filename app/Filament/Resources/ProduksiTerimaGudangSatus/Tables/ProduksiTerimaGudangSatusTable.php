...
namespace App\Filament\Resources\ProduksiTerimaGudangSatus\Tables;
...
class ProduksiTerimaGudangSatusTable
{
            ...
            ->recordActions([
                ...
                DeleteAction::make()
                    ...
                    ->before(function ($record, DeleteAction $action) {
                        ...
                        // 🔒 cek semua relasi
                        $hasRelation =
                            $record->pegawaiTerimaGudangSatu()->exists() ||
                            $record->bahanTerimaGudangSatu()->exists() ||
                            $record->validasiTerimaGudangSatu()->exists();

                        if ($hasRelation) {
                            Notification::make()
                                ->title('Gagal menghapus data')
                                ->body('Data produksi terima gudang satu tidak dapat dihapus karena masih memiliki data terkait.')
                                ->danger()
                                ->send();
