            ...
            ->schema([
                ...
                */
                ...
                Select::make('id_komposisi')
                    ...
                    ->options(function () {
                        ...
                        return Komposisi::query()
                            ...
                            ->mapWithKeys(function ($k) {
                                ...
                                $kategori =
                                    $bsj?->grade?->kategoriBarang?->nama_kategori
                                    ?? 'Kategori?';
                    ...
                    ->afterStateUpdated(
                        fn ($state) => session([
                            'detail_last_komposisi' => $state
                        ])
                    )
                    ->default(
                        fn () => session('detail_last_komposisi')
                    )
                    ->columnSpanFull(),
                ...
                */
                ...
                Select::make('grade_id')
                    ...
                    ->afterStateUpdated(
                        fn ($state) => session([
                            'detail_last_grade' => $state
                        ])
                    )
                    ->default(
                        fn () => session('detail_last_grade')
                    ),
                ...
                */
                ...
                Select::make('jenis_barang_id')
                    ...
                    ->afterStateUpdated(
                        fn ($state) => session([
                            'detail_last_jenis_barang' => $state
                        ])
                    )
                    ->default(
                        fn () => session(
                            'detail_last_jenis_barang'
                        )
                    ),
                ...
                */
                ...
                Select::make('id_barang_setengah_jadi_hp')
                    ...
                    ->afterStateUpdated(
                        fn ($state) => session([
                            'detail_last_barang_hp' => $state
                        ])
                    )
                    ->default(
                        fn () => session(
                            'detail_last_barang_hp'
                        )
                    ),
                    ...
                    ->rule(function (callable $get) {
                        return Rule::unique(
                            ...
                            ->where(
                                ...
                                $get('id_barang_setengah_jadi_hp')
                            );
                    })
                    ->validationMessages([
                        'unique' => 'Barang setengah jadi dengan lapisan ini sudah digunakan pada komposisi tersebut.',
                    ]),
