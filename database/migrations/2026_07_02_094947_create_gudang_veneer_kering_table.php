...
return new class extends Migration
{
    ...
    {
        Schema::create('gudang_veneer_kering', function (Blueprint $table) {
            $table->id();
            // Identitas produk
            ...
            $table->integer('stok_lembar_sebelum')->default(0);
        $table->integer('stok_lembar_sesudah')->default(0);
    ...
    {
        Schema::dropIfExists('gudang_veneer_kering');
    }
};
