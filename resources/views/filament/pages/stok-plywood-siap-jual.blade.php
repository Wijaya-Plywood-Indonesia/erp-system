...
<x-filament-panels::page>
    ...
    <div
        ...
        <span
            ...
            {{ $summaries->count() }} kombinasi · {{ number_format($this->totalLembar) }} lbr ·
            {{ number_format($this->totalKubikasi, 4) }} m³
        </span>
    </div>
            ...
            @forelse($grouped as $tebal => $rows)
                <div class="space-y-3">
                    ...
                    <div
                        ...
                        <table class="w-full min-w-[640px] text-sm text-left border-separate border-spacing-0">
                            <thead>
                                <tr
        ...
        @if ($summaries->count())
            <div
                ...
                <div @class([
                    ...
                    'grid-cols-1' => !$showKubikasi,
                    'grid-cols-1 sm:grid-cols-2' => $showKubikasi,
                ])>
                    <div class="px-6 py-5">
