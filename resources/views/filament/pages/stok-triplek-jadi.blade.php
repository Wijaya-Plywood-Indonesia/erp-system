{{-- resources/views/filament/pages/stok-triplek-jadi.blade.php --}}
        ...
        <div class="space-y-6">
            ...
            @empty
                <div
                    ...
                    Tidak ada stok triplek jadi tersedia
                </div>
            @endforelse
        </div>
            ...
            <div
                ...
                <div @class([
                    ...
                    <div class="px-6 py-5">
                        ...
                        <div class="text-xs text-gray-400 mt-0.5">lembar triplek jadi</div>
                    </div>
