{{-- resources/views/filament/pages/stok-platform-jadi.blade.php --}}
<x-filament-panels::page>
    ...
    <div
        ...
        <select wire:model.live="filterJenisBarang"
            ...
            @foreach (\App\Models\JenisBarang::orderBy('nama_jenis_barang')->pluck('nama_jenis_barang', 'id') as $id => $nama)
        ...
        <button type="button" wire:click="$toggle('showKubikasi')" @class([
    ...
    <div class="flex flex-col gap-8">
        ...
        <div class="space-y-6">
                            ...
                            <thead>
                                <tr
                                    ...
                                    <th
                                        ...
                                        No</th>
                                    <th class="px-6 py-3 border-b border-gray-100 dark:border-gray-800">Jenis Barang
                                    </th>
            ...
            @empty
                <div
                    ...
                    Tidak ada stok platform jadi tersedia
                </div>
            @endforelse
        </div>
        ...
        @if ($summaries->count())
            <div
                ...
                <div @class([
                    'grid divide-y sm:divide-y-0 sm:divide-x divide-gray-100 dark:divide-gray-800',
