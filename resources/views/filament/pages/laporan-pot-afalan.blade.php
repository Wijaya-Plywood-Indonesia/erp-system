<x-filament-panels::page>
    ...
    @php
        ...
        // Meratakan (flatten) semua pegawai dari semua produksi/meja hari itu jadi 1 list
        $semuaPekerja = $tables->flatMap(function ($table) {
                                ...
                                <tfoot
                                    ...
                                    <tr>
                                        <td colspan="7"
                                            ...
                                            <strong class="font-mono text-zinc-900 dark:text-white">{{ $p['jam_kerja'] }}</strong>
