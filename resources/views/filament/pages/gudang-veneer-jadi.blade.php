<x-filament-panels::page>
    ...
    'joint' => 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400',
    ];
    $labelMap = [
    'dryer' => 'Press Dryer',
    'kedi' => 'Kedi',
                ...
                <div
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-zinc-400 font-bold mt-0.5">({{ $item['jumlah_palet'] }}
                                plt)</p>
                        </div>
                        <div class="text-right">
                ...
                <table class="w-full text-left border-collapse text-sm">
                    ...
                    <tbody x-data="{ open: false }"
                        ...
                        <tr @click="open = !open"
                            ...
                            <td
                                class="py-3 px-3 text-center text-sm text-zinc-600 dark:text-zinc-300 font-mono">
                                {{ $item['panjang'] + 0 }}
                            </td>
                            <td
                                class="py-3 px-3 text-center text-sm text-zinc-600 dark:text-zinc-300 font-mono">
                ...
                <div class="space-y-1.5 relative" x-data="{
                        ...
                        get filteredOptions() {
                            ...
                            return this.options.filter(o =>
                                ...
                                o.no.toLowerCase().includes(term) ||
                                (o.no + ' | ' + o.nama).toLowerCase().includes(term)
                            );
                        },
                        selectVeneer(item) {
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-950/80 backdrop-blur-sm">
        <div
            ...
            <form wire:submit.prevent="updateKeluar" class="space-y-4 text-xs">
                ...
                {{-- PILIH ULANG SPESIFIKASI STOK (opsional saat edit) --}}
                <div class="space-y-1.5 relative" x-data="{
                        isDropdownOpen: false,
                        searchTerm: '',
                    ...
                    <label
                        class="text-[11px] font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider block">
                        Ganti Spesifikasi Veneer (opsional)
                    </label>
                    <div class="relative flex items-center">
                        <input type="text" x-model="searchTerm" @focus="isDropdownOpen = true"
                            placeholder="Ketik dimensi ukuran atau KW..."
