<div
    ...
    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-white/10">
        <div class="flex flex-col gap-3 sm:flex-row-reverse">
            <button @click="create(true)" class="w-full sm:w-auto rounded-lg bg-amber-600 px-4 py-2 text-sm font-semibold text-white hover:bg-amber-500">
                Simpan
            </button>

            <button @click="create(false)" class="w-full sm:w-auto rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-900 hover:bg-gray-50 dark:bg-white/5 dark:text-white dark:border-white/10">
                Simpan & Buat Lagi
            </button>

            <button @click="$dispatch('close-modal', { id: 'modal-offline-input' })" class="w-full sm:w-auto text-sm font-semibold text-gray-900 hover:underline sm:mr-auto dark:text-white">
                Batal
            </button>
        </div>
    </div>
