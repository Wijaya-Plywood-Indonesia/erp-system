        ...
        <x-filament::card class="dark:bg-gray-900 border-none shadow-sm">
            ...
            <div class="mt-8 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        @forelse ($summary['globalUkuranJenis'] as $row)
                            <div
                                class="flex justify-between items-center bg-gray-50 dark:bg-gray-800/50 px-4 py-3 rounded-xl border border-gray-100 dark:border-gray-700">
                                <div class="text-sm">
                                    <span
                                        class="font-medium text-gray-700 dark:text-gray-300">{{ $row->ukuran }}</span>
                ...
                @if (false)
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-gray-800 dark:text-gray-200 mb-3">Global Ukuran (Semua Jenis
                            Kayu)</h3>
                        <div class="space-y-2">
                        ...
                        <div
                            ...
                            <table class="w-full text-left text-sm text-gray-600 dark:text-gray-300">
                                ...
                                <tfoot class="bg-gray-50 dark:bg-gray-900/50 text-gray-900 dark:text-white font-bold">
                                    <tr>
                                        <td colspan="2" class="px-4 py-3 text-right border-t dark:border-gray-700">
