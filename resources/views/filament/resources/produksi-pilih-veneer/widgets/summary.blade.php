                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            @forelse ($summary['globalUkuranKw'] as $row)
                                <div
                                    class="flex justify-between items-center bg-gray-50 dark:bg-gray-800/50 px-5 py-3 rounded-xl border border-gray-100 dark:border-gray-700 transition-all duration-300">
                                    <div class="text-sm font-semibold text-gray-700 dark:text-gray-300">
                                        {{ $row->ukuran }}
                                        <span class="mx-1 text-gray-400 font-normal">•</span>
                                        <span class="text-gray-500 text-xs italic font-medium uppercase">Grade KW
                                            {{ $row->kw }}</span>
                                    </div>
